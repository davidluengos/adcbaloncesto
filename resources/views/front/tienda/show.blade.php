...
<div class="row">
        <div class="col-md-6">
            @if($producto->imagen)
                <img src="{{ asset($producto->imagen) }}" class="img-fluid rounded mb-3" alt="{{ $producto->nombre }}">
            @endif
            @if($producto->imagen2)
                <img src="{{ asset($producto->imagen2) }}" class="img-fluid rounded" alt="{{ $producto->nombre }}">
            @endif
        </div>
        <div class="col-md-6">
